const local: App.I18n.Schema = {
  ...
  route: {
    ...
    couponTemplates_edit: '编辑模板',
    couponTemplates_form: '模板表单',
    coupons_templates: '优惠券模板',
    coupons_templates_list: '模板列表',
    coupons_templates_create: '新建模板',
    coupons_templates_edit: '编辑模板',
    coupons_templates_form: '模板表单',
    memberTiers: '会员等级',
    memberTiers_list: '等级列表',
    memberTiers_create: '新建等级',
    memberTiers_edit: '编辑等级',
    memberTiers_form: '等级表单',
    membertiers: '会员等级',
    membertiers_list: '等级列表',
    membertiers_create: '新建等级',
    membertiers_edit: '编辑等级',
