const local: App.I18n.Schema = {
  ...
  route: {
    ...
    couponTemplates_edit: 'Edit Template',
    couponTemplates_form: 'Template Form',
    coupons_templates: 'Coupon Templates',
    coupons_templates_list: 'Template List',
    coupons_templates_create: 'Add Template',
    coupons_templates_edit: 'Edit Template',
    coupons_templates_form: 'Template Form',
    memberTiers: 'Member Tiers',
    memberTiers_list: 'Tier List',
    memberTiers_create: 'Add Tier',
    memberTiers_edit: 'Edit Tier',
    memberTiers_form: 'Tier Form',
    membertiers: 'Member Tiers',
    membertiers_list: 'Tier List',
    membertiers_create: 'Add Tier',
    membertiers_edit: 'Edit Tier',
