...
ADMIN_BASES = [
    '/www/wwwroot/pizza.artaides.com/admin',        # pizza.artaides.com Nginx root
]
...
def deploy_backend():
    ...
    migrations = [
        ...
        'pizza-server/db/migrate_birthday_lock.sql',
        'pizza-server/db/migrate_birthday_coupon_value.sql',
        'pizza-server/db/migrate_birthday_coupon_detail.sql',
        'pizza-server/db/migrate_birthday_dual_coupons.sql',
        'pizza-server/db/migrate_lucky_source_bonus.sql',
        'pizza-server/db/migrate_content_defaults.sql',
    ]
    for m in migrations:
