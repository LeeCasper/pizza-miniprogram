...
CREATE TABLE IF NOT EXISTS member_tiers (
    ...
    bg_start_color VARCHAR(30) DEFAULT 'rgba(60,60,65,0.88)',
    bg_end_color VARCHAR(30) DEFAULT 'rgba(25,25,30,0.95)',
...
('silver',    '银卡会员',   1,     0.00, 1.00, 1.00, '生日当月享9折优惠一次',         0.00, '#78d2ab', '#78d2ab', '#5a9e80'),
('gold',      '金卡会员',   2,   200.00, 0.98, 1.00, '生日当月享8折优惠一次',         5.00, '#8fc5fe', '#8fc5fe', '#6b94be'),
('rose_gold', '玫瑰金会员', 3,  1000.00, 0.95, 1.20, '生日当月享7折优惠+专属礼物',   10.00, '#ada1f0', '#ada1f0', '#8279b4'),
('platinum',  '铂金会员',   4,  3000.00, 0.90, 1.50, '生日当月享6折优惠+上门配送',   20.00, '#f8b95c', '#f8b95c', '#ba8b45'),
('diamond',   '钻石会员',   5, 10000.00, 0.85, 2.00, '生日当月享5折优惠+专属客服',   50.00, '#ee6155', '#ee6155', '#b34940');
